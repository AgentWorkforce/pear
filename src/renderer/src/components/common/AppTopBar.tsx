        ...
        <div className="relative">
          ...
          {historyOpen && (
            <>
              ...
              <div className="titlebar-nodrag absolute left-0 top-10 z-30 w-[520px] max-w-[calc(100vw-24px)] overflow-hidden rounded-[18px] border border-[var(--pear-border)] bg-[var(--pear-bg-surface)] py-4 shadow-2xl">
                  ...
                  {recentTabs.length === 0 ? (
                    ...
                    recentTabs.map((tab) => (
                      <button
                        ...
                        className="flex w-full min-w-0 items-center gap-3 rounded-lg px-3 py-2.5 text-left text-[var(--pear-text)] hover:bg-[var(--pear-bg-surface-hover)]"
                      >
            ...
            >
              ...
              {canClose && (
                <button
                  ...
                  className={`mr-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-md transition-opacity hover:bg-[var(--pear-bg-surface-hover)] hover:text-[var(--pear-text)] ${
