...
export const INTEGRATIONS_CATALOG: IntegrationAdapter[] = [
  ...
  },
  {
    ...
    iconUrl: 'https://app.nango.dev/images/template-logos/cloudflare.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/cloudflare'],
    description: 'Cloudflare adapter package for Relayfile'
  },
  {
    provider: 'confluence',
  ...
  },
  {
    provider: 'daytona',
    displayName: 'Daytona',
    iconUrl: 'https://app.nango.dev/images/template-logos/daytona.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/daytona'],
    description: 'Daytona adapter package for Relayfile'
  },
  {
    provider: 'docker-hub',
    displayName: 'Docker Hub',
    iconUrl: 'https://app.nango.dev/images/template-logos/docker-hub.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/docker-hub'],
    description: 'Docker Hub adapter package for Relayfile'
  },
  {
    provider: 'dropbox',
    displayName: 'Dropbox',
  ...
  },
  {
    provider: 'fathom',
    displayName: 'Fathom',
    iconUrl: 'https://app.nango.dev/images/template-logos/fathom.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/fathom'],
    description: 'Fathom adapter package for Relayfile'
  },
  {
    provider: 'gcp',
    displayName: 'Gcp',
    iconUrl: 'https://app.nango.dev/images/template-logos/gcp.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/gcp'],
    description: 'GCP adapter package for Relayfile'
  },
  {
    provider: 'gcs',
  ...
  },
  {
    provider: 'granola',
    displayName: 'Granola',
    iconUrl: 'https://app.nango.dev/images/template-logos/granola.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/granola'],
    description: 'Granola adapter package for Relayfile'
  },
  {
    provider: 'hubspot',
    displayName: 'HubSpot',
  ...
  },
  {
    provider: 'neon',
    displayName: 'Neon',
    iconUrl: 'https://app.nango.dev/images/template-logos/neon.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/neon'],
    description: 'Neon adapter package for Relayfile'
  },
  {
    provider: 'notion',
    displayName: 'Notion',
  ...
  },
  {
    provider: 'recall',
    displayName: 'Recall',
    iconUrl: 'https://app.nango.dev/images/template-logos/recall.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/recall'],
    description: 'Recall adapter package for Relayfile'
  },
  {
    provider: 'reddit',
    displayName: 'Reddit',
    iconUrl: 'https://app.nango.dev/images/template-logos/reddit.svg',
    version: '0.2.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/reddit'],
  ...
  },
  {
    ...
    iconUrl: 'https://app.nango.dev/images/template-logos/telegram.svg',
    version: '0.1.0',
    capabilities: { webhook: true, poll: true, writeback: true },
    authMethod: 'oauth',
    defaultMountPaths: ['/integrations/telegram'],
    description: 'Telegram Bot API adapter for Relayfile messaging, conversation history, and bot configuration'
  },
  {
    provider: 'x',
